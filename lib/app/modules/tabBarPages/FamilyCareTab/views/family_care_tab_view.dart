                        ...
                        Obx(
                          () => AnimatedToggleSwitch<bool>.dual(
                            ...
                            onChanged: (checked) {
                              ...
                              if(checked == true){
                                NotificationService().showNotification("Message", "coming" , 1);
                              }
                              else {
                                                        ...
                                                        actions: <Widget>[
                                                          MyElevatedButton(
                                                            ...
                                                            onTap: () {
                                                              ...
                                                              Fluttertoast.showToast(msg: "deleted",backgroundColor: primaryColor);
                                                            },
                                                            text: 'Delete',
                                                            iconData:
                                                                Icons.delete,
                      ...
                      MyButton(
                        onTap: () {
                          ...
                          controller.postApiData(AlarmModel(
                            ...
                            time: "${DateFormat('dd-MM-yyyy').format(controller.selectedDate.value)} ${controller.selectedTime}",
                            status: true,
                          ));
